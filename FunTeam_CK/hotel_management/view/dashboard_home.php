...
// --- FIX LỖI MẤT DỮ LIỆU ---
// Không gọi lại DashboardController ở đây nữa.
// Chúng ta chỉ nhận biến đã được tính toán từ file dashboard.php truyền sang.
              ...
              <tr>
                ...
                <td>
                    <?php 
                        ...
                        if(stripos($st,'DaNhan')!==false || stripos($st,'Đang')!==false || stripos($st,'CheckIn')!==false) $cls='checkedin';
...
<div class="modal fade" id="addRoomModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title fw-bold">Thêm phòng mới</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><form id="roomForm"><div class="modal-body">
    <div class="mb-3"><label class="form-label">Số phòng</label><input name="soPhong" class="form-control" required></div>
    <div class="mb-3"><label class="form-label">Tầng</label>
        <select name="tangPhong" class="form-select">
            <option value="">-- Chọn tầng --</option>
            <option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option>
            <option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option>
        </select>
    </div>
    <div class="mb-3"><label class="form-label">Hạng phòng</label><select name="hangPhong" class="form-select"><option value="">-- Chọn hạng phòng --</option><option value="LP001">Standard</option><option value="LP002">Superior</option><option value="LP003">Deluxe</option><option value="LP004">Suite</option><option value="LP005">Family</option></select></div>
    <div class="mb-3"><label class="form-label">Sức chứa</label><input name="sucChua" class="form-control" type="number"></div>
    <div class="mb-3"><label class="form-label">Đơn giá</label><input name="giaPhong" class="form-control" type="number"></div>
</div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button><button type="submit" class="btn btn-primary">Lưu thay đổi</button></div></form></div></div></div>
