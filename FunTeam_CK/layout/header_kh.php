...
if ($is_in_view_folder) {
    ...
    $index_path = '../view/dashboard_khachhang.php';
    $login_path = 'login.php';
    $register_path = 'dangky_khachhang.php';
    $lienhe_path = 'lienhekh.php';
    $khuyenmai_path = 'khuyenmai.php';
} else {
    $logo_path = 'img/logos.jpg';
    $index_path = '../view/dashboard_khachhang.php';
...
if (isset($_GET['logout']) && $_GET['logout'] == 'true') {
    ...
    // THAY VÌ header(), dùng JavaScript redirect
    echo '<script>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <div class="col-md-9 mx-5">
                    <ul class="navbar-nav justify-content-center w-100">
                        ...
                        <li class="nav-item mx-2">
                            <a href="phong/TraCuuPhong.php" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-user-plus me-1 fs-4 px-3"></i>Tra cứu phòng
                            </a>
                        </li>
                        <li class="nav-item mx-2">
                        ...
                        <li class="nav-item mx-2">
                            <a href="dangKyDichVuBoSung.php" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-door-open me-1 fs-4 px-3"></i>Đăng ký dịch vụ
                            </a>
                        </li>
