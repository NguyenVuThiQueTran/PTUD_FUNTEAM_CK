...
if (!isset($_SESSION["dn"]) || $_SESSION["dn"] !== true || $_SESSION["role"] !== 'quanly') {
    header("Location: ../index.php");
    exit();
}

// **SỬA: Đặt biến session cho header nhận diện - ĐẶT SAU KIỂM TRA ĐĂNG NHẬP**
$_SESSION['user_role'] = 'quanly';
$_SESSION['current_dashboard'] = 'dashboard_quanly.php';

// Định nghĩa đường dẫn
$base_path = dirname(__DIR__); // Thư mục gốc của project
$index_path = '../index.php'; // Trỏ về index.php từ thư mục view
$dashboard_path = 'dashboard_quanly.php'; // Tên file dashboard hiện tại
...
$stats = $p->mGetDashboardData('quanly', isset($_SESSION["user_id"]) ? $_SESSION["user_id"] : null);
...
<body>
    <div class="container-fluid">
        ...
        <div id="header" >
            <?php include('../layout/header_ql.php'); ?>
        </div>
