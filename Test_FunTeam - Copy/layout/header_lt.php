                ...
                <div class="col-md-9 mx-5">
                    <ul class="navbar-nav justify-content-center w-100">
                        ...
                        <li class="nav-item mx-2">
                            <a href="<?php echo htmlspecialchars($home_path); ?>" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-home me-1 fs-4 px-3"></i>Trang Chủ
                            </a>
                        </li>
                        <li class="nav-item mx-2">
                            <a href="register.php" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-user-plus me-1 fs-4 px-3"></i>Đăng ký tài khoản khách hàng
                            </a>
                        </li>
                        <li class="nav-item mx-2">
                            <a href="nhanphong.php" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-door-open me-1 fs-4 px-3"></i>Nhận phòng cho khách
                            </a>
                        </li>
                        <li class="nav-item mx-2">
                            <a href="huygiaodich.php" class="nav-link text-white nav-menu-item">
                                <i class="fas fa-times-circle me-1 fs-4 px-3"></i>Hủy giao dịch
                            </a>
                        </li>
                        <li class="nav-item mx-2">
                            <a href="traphong.php" class="nav-link text-white nav-menu-item">
    ...
    <ul id="ul2" class="navbar-nav justify-content-end">
        <?php if ($isLoggedIn): ?>
            ...
            <li class="nav-item dropdown" onmouseover="showDropdown(this)" onmouseout="hideDropdown(this)">
                <a class="nav-link text-white fs-6 fw-bold d-flex align-items-center" 
                   href="#" 
                   id="userDropdown">
